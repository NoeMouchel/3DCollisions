#include "../Include/Referential2.h"
...
void ToolBox::Referential2::setAngle(float angle)
{
    j.rotate(angle);
    i.rotate(angle);
}
...
//      Local -> Global
Vector2f ToolBox::localToGlobalVector(Referential2 local_ref, Vector2f local_point)
{
...
//      Global -> Local 
Vector2f ToolBox::globalToLocalVector(Referential2 local_ref, Vector2f global_point)
{
...
//      Local -> Global
Vector2f ToolBox::localToGlobalPoint(Referential2 local_ref, Referential2 global_ref, Vector2f local_point)
{
...
//      Global -> Local 
Vector2f ToolBox::globalToLocalPoint(Referential2 local_ref, Referential2 global_ref, Vector2f global_point)
{
...
ConvexPolygon ToolBox::localToGlobalConvex(ConvexPolygon poly, Referential2 ref)
{
