...
Range2 ToolBox::range2Point(Vector2f point, Vector2f axe)
{ 
    Range2 range(point.dot(axe));
    return range;
}

Range2 ToolBox::range2Segment(Segment seg, Vector2f axe)
{ 
    Range2 range(seg.a.dot(axe), seg.b.dot(axe));
    return range;
}

Range2 ToolBox::range2Circle(Circle cir, Vector2f axe)
{ 
...
Range2 ToolBox::range2Box(Box box, Vector2f axe)
{
