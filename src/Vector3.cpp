...
void ToolBox::Vector3f::operator-=(const Vector3f& a)
{
	*this = *this - a;
}
...
void ToolBox::Vector3f::operator-=(const float a)
{
	*this = *this - a;
}
...
float ToolBox::dotProduct(const Vector3f& a, const Vector3f& b)
{
	return a.x * b.x + a.y * b.y + a.z * b.z;
}


float ToolBox::getDistance(const Vector3f& a, const Vector3f& b)
{
